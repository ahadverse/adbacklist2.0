...
import Deposit from "@/components/diposit/deposit";
    ...
    <div className='bg-gray-200 h-fit'>
      ...
      <div className='border-4 rounded border-dashed border-green-600 sm:mt-10 mt-10  mx-auto sm:w-3/5 p-5'>
        ...
        <div>
          ...
          <button className='bg-cyan-500 sm:mt-0 mt-5 shadow-lg shadow-cyan-500/50 text-white text-normal py-1 px-3 rounded ml-5'>
            <a href='https://bitcoin.com/' target='_blank'>
              binance.com
            </a>
          </button>
